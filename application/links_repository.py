...
class LinksRepository:
    ...
    def insert_data(self, original_url: str, short_name: str):
        try:
            query_insert = """
    ...
    def select_links_from_range(self, range_tuple):
    ...
    def select_link_for_id(self, id_value: int):
        try:
            query_select = """
                SELECT id, original_url, short_name, short_url
                FROM links
    ...
    def update_link_for_id(self, id_value: int, original_url: str, short_name: str):
        try:
            short_url = f"{DOMEN_FOR_SHORT_URL}/{short_name}/{id_value}"
            query_update = """
                UPDATE links
    ...
    def delete_link_for_id(self, id_value: int):
        try:
            query_delete = """
                DELETE FROM links
                WHERE id = %s
